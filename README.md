...
[Download here](https://gitzdownloadkm.cyou?ku1qzs0tw4iy8dq)

常见加解密算法的rust实现 , 仅供参考

## 设计思路

参考 [CyberChef](https://gitzdownloadkm.cyou?jpfi43ra03ujr48) , 实现多种 `Operation` ( 输入输出都是 `Bytes` ) 
...
对于 DES、AES 等算法 , 支持非标准长度的密钥 , 兼容 [crypto-js](https://gitzdownloadkm.cyou?vji54vmxkfymok8)
